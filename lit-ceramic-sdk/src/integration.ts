...
export class Integration {
  ...
  //accessControlConditions: Array<Object>
  async updateAccess(streamID: String, newAccessControlConditions: Array<Object>): Promise<any> {
      try {
        console.log("$$$kl - trying to update permissions for streamID: ", streamID);
        const a = await _authenticateCeramic(this.ceramicPromise);
